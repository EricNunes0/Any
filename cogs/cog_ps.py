...
class cog_ps(commands.Cog):
    ...
    async def mine(self, ctx, *, mensagem=None):
        ...
        await ctx.send(content = f"**{ctx.author.mention} <:anicoin:919293624850727022>| +{earnings}**", file=discord.File('img_conquistamine.png'))
    ...
    async def notstonks(self, ctx, *, mensagem=None):
        ...
        await ctx.send(content = f"**{ctx.author.mention} <:anicoin:919293624850727022>| +{earnings}**",file=discord.File('img_notstonks.png'))
    ...
    async def ytcomment(self, ctx, *, mensagem=None):
        ...
        await ctx.send(content = f"**{ctx.author.mention} <:anicoin:919293624850727022>| +{earnings}**",file=discord.File('img_ytcomentario.png'))
