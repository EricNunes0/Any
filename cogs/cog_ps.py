...
class cog_ps(commands.Cog):
    ...
    async def stonks(self, ctx, *, mensagem=None):
        ...
        await ctx.send(content = f"**{ctx.author.mention} <:anicoin:919293624850727022>|**",file=discord.File('img_stonks.png'))
    ...
    async def notstonks(self, ctx, *, mensagem=None):
        ...
        img = Image.open("img_notstonks(1).png")
        fonte = ImageFont.truetype("font_coolvetica_rg.ttf", 35)
        escrever = ImageDraw.Draw(img)
        escrever.text(xy=(10,10), text=f"{mensagem}", fill=(20, 20, 20), font=fonte)
        img.paste(avatar, (95, 65), avatar)
        img.save('img_notstonks.png')
        await ctx.send(content = f"**{ctx.author.mention} <:anicoin:919293624850727022>|**",file=discord.File('img_notstonks.png'))
    ...
    async def ytcomment(self, ctx, *, mensagem=None):
        ...
        img = Image.open("img_ytcomentario(1).png")
        ...
        img.save('img_ytcomentario.png')
        await ctx.send(content = f"**{ctx.author.mention} <:anicoin:919293624850727022>|**",file=discord.File('img_ytcomentario.png'))
    ...
    async def tweet(self, ctx, *, mensagem=None):
        ...
        await ctx.reply(content = f"**{ctx.author.mention} <:anicoin:919293624850727022>|**", file=discord.File('img_tweet.png'))
    ...
    async def candidato(self, ctx, member: discord.Member = None):
        ...
        await ctx.send(content = f"**{ctx.author.mention} <:anicoin:919293624850727022>|**",file=discord.File('img_candidato.png'))
    ...
    async def clyde(self, ctx, *, mensagem=None):
        ...
        await ctx.send(content = f"**{ctx.author.mention} <:anicoin:919293624850727022>|**",file=discord.File('img_clyde.png'))
    ...
    async def christmasgift(self, ctx, member:discord.Member = None):
        ...
        await ctx.send(content = f"**{ctx.author.mention} <:anicoin:919293624850727022>|**",file=discord.File('img_natal.png'))
    ...
    async def laranjo(self, ctx, *, mensagem=None):
        ...
        await ctx.send(content = f"**{ctx.author.mention} <:anicoin:919293624850727022>|**",file=discord.File('img_laranjo.jpg'))
    ...
    async def fato(self, ctx, *, mensagem=None):
        ...
        await ctx.reply(content = f"**{ctx.author.mention} <:anicoin:919293624850727022>|** {ctx.author.mention}", file=discord.File('img_fato.png'))
    ...
    async def srincrivel(self, ctx, i:int = None, *, mensagem=None):
        ...
        await ctx.reply(content = f"**{ctx.author.mention} <:anicoin:919293624850727022>|**", file=discord.File('img_sr_incrivel.png'))
    ...
    async def facecomment(self, ctx, *, mensagem=None):
        ...
        await ctx.reply(content = f"**{ctx.author.mention} <:anicoin:919293624850727022>|**", file=discord.File('img_facecomment.png'))
    ...
    async def instacomment(self, ctx, *, mensagem=None):
        ...
        await ctx.reply(content = f"**{ctx.author.mention} <:anicoin:919293624850727022>|**", file=discord.File('img_instacomment.png'))
    ...
    async def xcomment(self, ctx, *, mensagem=None):
        ...
        await ctx.reply(content = f"**{ctx.author.mention} <:anicoin:919293624850727022>|**", file=discord.File('img_xcomment.png'))
    ...
    async def pp(self, ctx, *, mensagem=None):
        ...
        await ctx.reply(content = f"**{ctx.author.mention} <:anicoin:919293624850727022>|**", file=discord.File('img_pp.jpeg'))
    ...
    async def captcha(self, ctx, member:discord.Member = None, *, mensagem=None):
        ...
        await ctx.reply(content = f"**{ctx.author.mention} <:anicoin:919293624850727022>|**", file=discord.File('img_captcha.png'))
    ...
    async def crewmate(self, ctx):
        ...
        await ctx.reply(content = f"**{ctx.author.mention} <:anicoin:919293624850727022>|**", file=discord.File('img_crewmates.png'))
    ...
    async def avataredit(self, ctx, member:discord.Member = None, *, filter = None):
        ...
        await ctx.send(content = f"**{ctx.author.mention} <:anicoin:919293624850727022>|**", file=discord.File('img_avatar.png'))
    ...
    async def hipocrisia(self, ctx, *, mensagem=None):
        ...
        await ctx.reply(content = f"**{ctx.author.mention} <:anicoin:919293624850727022>|**", file=discord.File('img_hipocrisia.png'))
    ...
    async def bbb22(self, ctx, member:discord.Member = None):
        ...
        await ctx.send(content = f"**{ctx.author.mention} <:anicoin:919293624850727022>|**",file=discord.File('img_bbb22.png'))
