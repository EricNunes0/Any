...
class cog_diversos(commands.Cog):
    def __init__(self, bot):
        self.bot = bot

    @commands.command(name = "diversos", aliases = ["infos", "extras"], pass_context = True)
...
async def setup(bot):
    print(f"{prefix}diversos")
    await bot.add_cog(cog_diversos(bot))