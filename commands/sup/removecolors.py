...
class cog_removecolors(commands.Cog):
    def __init__(self, bot):
        self.bot = bot

    @commands.command(name = "removecolors", aliases = ["removecolorsall"], pass_context = True)
...
async def setup(bot):
    print(f"{prefix}removecolors")
    await bot.add_cog(cog_removecolors(bot))